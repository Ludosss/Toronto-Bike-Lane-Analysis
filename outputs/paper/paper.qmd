...
This paper uses the TTC Bus Delay Data [@busdata] retrieved from the City of Toronto's Open Data Portal via the opendatatoronto library [@datator]. The dataset contains data regarding numerous factors that constitute a bus delay
